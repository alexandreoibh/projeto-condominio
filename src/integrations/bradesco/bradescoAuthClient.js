...
const { requisitarToken } = require('./bradescoHttpClient');

// Cache L1 por processo — mesmo padrão de interAuthClient.js/itauAuthClient.js:
// evita round-trip ao Postgres dentro da mesma invocação/instância quente. A
 ...
 * mTLS é sempre obrigatório no Bradesco (certificado exigido para gerar
 * qualquer credencial no portal).
 *
 * @param {object} params
